                            ...
                            <div key={project.id} className="border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden">
                                ...
                                <AnimatePresence>
                                    {expandedProjects.includes(project.id) && (
                                        ...
                                        >
                                            {columns.map(column => {
                                                const projectTasks = getTasksByProjectAndStatus(project.id, column.id);
                                                return (
                                                    <div key={column.id}>
                                                        <div className="flex items-center justify-between mb-3">
                                                            <h4 className="font-medium text-slate-700 dark:text-slate-300 text-sm flex items-center gap-2">
                ...
                <DragOverlay>
                    {activeId ? (
                        <div className="opacity-50">
                            ...
                            <div className="bg-white dark:bg-slate-800 p-4 rounded-xl border-2 border-pink-500 shadow-xl w-[250px]">
                                Dragging Task...
                            </div>
                        </div>
                    ) : null}
